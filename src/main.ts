...
interface Windows {
  ...
  hotkeys?: (key: string, option: any, method: any) => void
  ;
}
...
interface Api {
  ...
  getScope?: () => string;
  deleteScope?: (scope: any, newScope: any) => void;
  getPressedKeyCodes?: () => any[];
  isPressed?: (keyCode: any) => boolean;
  filter?: (event: any) => boolean;
  // unbind?: (keysInfo: object | string, ...args: any[]) => void;
...
interface Hotkeys extends Api {
  (key: string, option: any, method: any): void
  noConflict?: (scope: any) => void;
}
...
// 返回键码
const code = (x: any) => _keyMap[x.toLowerCase()]
...
function isPressed(keyCode: any) {
...
function deleteScope(scope: any, newScope: any) {
  let handlers;
  let i;
...
interface Info {
  key: string; scope: string; method: string, splitKey?: string,
}
...
// function unbind(keysInfo?: Info[], args?: any): void;
// function unbind(keysInfo?: { key: string; scope: string; method: string, splitKey?: string, }, args?: any): void {

function unbind(keysInfo?: Info[] | Info | string, args?: any): void {
  // function unbind(keysInfo?: Info, args?: any): void
  // function unbind(keysInfo?: any, args?: any): void {
...
// 对监听对应快捷键的回调函数进行处理
function eventHandler(event: any, handler: any, scope: any) {
  let modifiersMatch;
...
const hotkeys: any = function hotkeys(key: any, option: any, method: any) {
  _downKeys = [];
